...
| DD-01 | MANUAL_REQUIRED | API/application keys and AP1 workflow read access verified on 2026-09-13. Set DD_BITS_WORKFLOW_ID for a reviewed workflow using the supplied DD_AGENT_ID: neither published workflow currently references it. Configure structured output and a restricted service-account execution identity; verify Runner permissions. | Connected private operational agent; authentication itself is verified |
